...
voter_turnout_df1 <- read_excel('data/G04ResultsDetail2004-11-02.xls', sheet=2, skip=1)
...
voter_turnout_df2 <- read_excel('data/G04ResultsDetail2004-11-02.xls', sheet=2, skip=2,
